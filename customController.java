...
public class customController implements ActionListener
{
  ...
  /** Default constructor
    ...
    */ 
  public customController(shortAnswerModel model, JButton add, JTextArea questionField, JTextArea answerField, 
                          ButtonGroup optionGroup, ButtonGroup solveGroup, shortAnswerGUI gui, CreateTestGUI ctGUI)
  {
    this.model = model;
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      if(yesNo.equals("Write your own solution")) //if they want to make their own solution
      {       
        this.getWords();
    ...
    else if(option.equals("Work With My Own Templates")) //if they want to use a template
    {
      this.oT = new OwnTemplateGUI(model,cT);
    }
